...
class YeSchoolRankingScreen extends StatelessWidget {
  const YeSchoolRankingScreen({super.key});
      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            ...
            appBarTitleText('ranking szkół'.titleCase),
          ],
        ),
        centerTitle: true,
        toolbarHeight: 80.0,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ListView.separated(
                      shrinkWrap: true,
                      physics: const BouncingScrollPhysics(),
                      itemBuilder: (context, index) => const YeSingleSchool(),
